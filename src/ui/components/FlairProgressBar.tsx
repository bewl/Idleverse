...
export function FlairProgressBar({ value, color = 'cyan', className = '' }: FlairProgressBarProps) {
  ...
  return (
    <div
      ...
      style={{
        ...
        // CSS vars for the charging animation
    ...
    >
      {/* Quarter-segment tick marks — tinted by bar color ahead, dark behind fill */}
      {[25, 50, 75].map(t => (
        <div
          key={t}
      ...
      {/* Fill container — clips the shimmer to the filled region */}
      {pct > 0 && (
        <div
        ...
        >
          ...
          />
          {/* Shimmer strip — sweeps across the fill */}
          {active && (
            <div
              className="absolute inset-0"
              style={{
          ...
          {/* Charging overlay: extra bright pulse near the bright end */}
          {charging && (
            <div
              className="absolute inset-0"
              style={{
          ...
          {/* Done overlay: extra bright gradient edge */}
          {done && (
            <div
              className="absolute inset-0"
              style={{
